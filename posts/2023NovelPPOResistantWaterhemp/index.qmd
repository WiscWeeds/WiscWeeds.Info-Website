...
Switching back to our investigation, after comparing the concerning A92 population to a known
PPO-inhibitor susceptible population (A66) via replicated dose-response greenhouse experiments with sulfentrazone (Spartan 4F®; field label rate: 8 fl oz ac^-1^) and fomesafen (Flexstar®; field label rate: 16 fl oz ac^-1^), we observed that the sulfentrazone ED~50~ for the A66 population was 32.8 g ai ha^-1^ compared to 87.6 g ai ha^-1^ for the A92 population (see Figures 2 and 3). In other words, we needed almost **three
times** more sulfentrazone to obtain 50% plant density reduction for the A92 compared to the A66 population. Fomesafen results were even more alarming: fomesafen ED~50~ for the A66 population was 13.5 g ai ha^-1^ compared to 132.0 g ai ha^-1^ for the A92 population (see Figures 4 and 5); almost **ten times** more active ingredient needed.
...
-   These results are very concerning given the importance of these two herbicides for
    residual waterhemp control in Wisconsin soybean production.
